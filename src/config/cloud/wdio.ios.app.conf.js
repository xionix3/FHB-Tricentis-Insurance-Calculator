...
export const config = {
    ...
    protocol: userConfig.headspinHostConfig.protocol,
    hostname : userConfig.headspinHostConfig.hostname,
    port : userConfig.headspinHostConfig.port,
    path : userConfig.headspinHostConfig.path,
    ...
    suites: {
        mobileAndroid: [
            '../../specs/mobileAndroid.spec.js'
        ],
        mobileIOS: [
            '../../specs/mobileiOS.spec.js'
        ],
        web: [
            '../../specs/web.spec.js'
        ]
